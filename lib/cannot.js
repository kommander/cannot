...
function extend(propName, value, options) {
  ...
  if (opts.type === 'proto') {
    ...
    Cannot.prototype[propName] = value;
  }
  ...
  if (opts.type === 'get') {
    ...
    if (typeof value !== 'function') {
      throw Cannot('extend', 'prototype').because('value needs to be a function'); // eslint-disable-line
    }
    Cannot.prototype.__defineGetter__(propName, value);
  }
  return true;
}
