...
(function(module, global){
  ...
  Cannot.emitErrorEvent = typeof config.emitErrorEvent !== 'undefined' ? config.emitErrorEvent : true;
  
  // Try to define non enumerable properties
  if(typeof Object.defineProperties === 'function'){
    var _throwTimeout;
    Object.defineProperty(Object.prototype, '_throwTimeout', {
      get : function(){ return _throwTimeout; },
      set : function(newValue){ _throwTimeout = newValue; },
      configurable: true
    });

    var _stack;
    Object.defineProperty(Object.prototype, '_stack', {
